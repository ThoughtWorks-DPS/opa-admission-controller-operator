...
# twdps.io/opa-admission-controller-operator-bundle:$VERSION and twdps.io/opa-admission-controller-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= twdps.io/opa-admission-controller-operator
